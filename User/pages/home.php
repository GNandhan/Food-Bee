              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <div class="input-group">
                    <input type="password" class="form-control rounded-start-pill"
                      placeholder="Enter your Email here" />
                    <button class="btn rounded-end-pill p-1" style="background-color: white;"><span
                        class="btn btn-warning rounded-pill">Subscribe Now</span></button>
                  </div>
        ...
        <div class="container">
          <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 pt-5">
            <div class="col-lg col-md col-sm col mb-3">
              <a href="/"
                class="d-flex align-items-center mb-3 link-body-emphasis fs-2 fw-bold text-white text-decoration-none">
                <img src="../static/icon.png" alt="" width="40">Food<span class="text-warning">Bee</span>
              </a>
              <p class="text-white">FoodBee simplifies food management by connecting users with surplus food from
                caterers.
        ...
        <div class="container">
          <footer class="d-flex flex-wrap justify-content-between align-items-center py-5">
            ...
            <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
              <li class="ms-3"><a class=" text-white" href="#"><i class="bi bi-facebook" width="24" height="24"></i></a>
              </li>
